...
# installed.
TCL_PREFIX='C:/GameMaking_Godot/Projects/AI工具/PythonFiles/PyWebCatch\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='C:/GameMaking_Godot/Projects/AI工具/PythonFiles/PyWebCatch\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='C:/GameMaking_Godot/Projects/AI工具/PythonFiles/PyWebCatch\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IC:/GameMaking_Godot/Projects/AI工具/PythonFiles/PyWebCatch\Library\include'
...
TCL_PACKAGE_PATH='C:/GameMaking_Godot/Projects/AI工具/PythonFiles/PyWebCatch\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LC:/GameMaking_Godot/Projects/AI工具/PythonFiles/PyWebCatch\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='C:/GameMaking_Godot/Projects/AI工具/PythonFiles/PyWebCatch\Library\lib\tclstub86.lib'
